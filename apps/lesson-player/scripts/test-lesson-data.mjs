...
assert(theme3Lessons.length === 17, "Tema 3 yazma s.225–229 ile on yedi doğal blok içermeli.");
...
assert(theme3Lessons.reduce((sum,l)=>sum+l.coverage.steps,0)===286 &&
  theme3Lessons.reduce((sum,l)=>sum+l.coverage.source_records,0)===131 &&
  theme3Lessons.reduce((sum,l)=>sum+l.coverage.answer_entries,0)===131,
  "Tema 3 mevcut kapsamı 286 adım / 131 source / 131 answer olmalı.");
...
assert(theme3Lessons.reduce((s,l)=>s+l.coverage.steps,0) === 286 &&
  theme3Lessons.reduce((s,l)=>s+l.coverage.source_records,0) === 131 &&
  theme3Lessons.reduce((s,l)=>s+l.coverage.answer_entries,0) === 131,
  "Tema 3 mevcut kapsamı 17 ders / 286 adım / 131 source / 131 answer olmalı.");
...
assert(theme3Lessons.reduce((sum,lesson)=>sum+lesson.coverage.steps,0)===286 &&
 theme3Lessons.reduce((sum,lesson)=>sum+lesson.coverage.source_records,0)===131 &&
 theme3Lessons.reduce((sum,lesson)=>sum+lesson.coverage.answer_entries,0)===131,
 "Tema 3 toplam 17 ders / 286 adım / 131 source / 131 answer olmalı.");
